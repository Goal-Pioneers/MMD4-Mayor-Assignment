...
<script type="text/babel" src="<?php echo get_template_directory_uri() . '/content/react/somelabel.jsx'; ?>">
</script>


<script type="text/babel" src="<?php echo get_template_directory_uri() . '/content/react/misc.jsx'; ?>">
*/